...
function President({ president }: presidentType) {
  ...
  return (
    <>
      ...
      {
        <div>
          <label className="pt-3 pb-2">Years in office: </label>
          {" " + president.yearsInOffice}
          <br />
          <label className="">Vice president: </label>
